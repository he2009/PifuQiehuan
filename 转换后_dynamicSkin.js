	...
	decadeUI.dynamicSkin = {
		...
		re_xiaoqiao: {
			采莲江南: {
				...
				hideSlots: ["guang3_30","bghua1","bgshitou1","bgshitou2","hehua1","hehua2","hehua3","hehua4","shuchong1","shuchong2","shugan","shui1","shui2","shuimian","shuiwen1","shuiwen2","shuiwen3","qjhehua","heye2"],
				skinName: "采莲江南",
			},
			花好月圆: {
